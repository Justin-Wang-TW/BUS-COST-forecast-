...
const sourceMap: Record<string, string> = {
  "cpi-ppi": "行政院主計總處 (DGBAS)",
  "salary": "行政院主計總處 / 勞動部",
  "gas": "台灣中油公司 (CPC)",
  "electricity": "台灣電力公司 (Taipower)",
  "interest": "中央銀行 (Central Bank of the ROC)"
};
  ...
  return (
    <div className="flex-1 flex flex-col pt-4 bg-slate-50 animate-in fade-in duration-500 overflow-y-auto">
      <div className="px-6 mb-4 flex justify-between items-end">
        ...
        <div className="text-xs text-slate-400 bg-slate-100 px-3 py-1 rounded inline-flex items-center gap-1 transition-all duration-300">
